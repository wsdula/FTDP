...
def Transform(n, someset):
    ans = int(input("Would you like to get the area 4 numbers? "))
    if ans == 4:
        i = 0
        x = len(someset)
        while i < x:
...
def partition(alist,first,last):
   ...
   return rightmark
''' THIS IS WHERE THE REST OF THE PROGRAM BEGINS '''
n = int(input("How long are the paths? "))
BaseCase = [[1,2,2], [2,3,3], [3,4,4], [4,5,5], [1,2,3], [2,3,4], [3,4,5], [1,2,4], [1,2,5], [1,3,5], [1,3,4], [1,4,5], [2,3,5], [2,4,5]]  #Makes base case unordered
